...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=ADMINPC;Database=BikeStores; User Id=sa; Password=P13-1688p;Trusted_Connection=True;TrustServerCertificate=True; ");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Brand>(entity =>
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E27396A0A04");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B444852C79");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB85AF3A0D3D");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__46596229EBBF3E54");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D45DB035D7");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF5036AF30A");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9C0B81BDB0");

            entity.ToTable("staffs", "sales");

            entity.HasIndex(e => e.Email, "UQ__staffs__AB6E6164F99938F4").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D3EBB8FCCA");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30C45D6AE1D");
